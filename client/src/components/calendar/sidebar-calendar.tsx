...
import { format, startOfMonth, endOfMonth, eachDayOfInterval, isSameMonth, 
  isToday, isSameDay, addMonths, subMonths } from "date-fns";
...
const SidebarCalendar: React.FC<SidebarCalendarProps> = ({ 
  ...
  // Handle navigating to create a new order
  const handleCreateOrder = (date: Date) => {
    // Save the date in localStorage
    localStorage.setItem('selectedEventDate', date.toISOString());
    
    // Navigate to new order page with the date
    navigate(`/orders/new?eventDate=${date.toISOString()}`);
  };
