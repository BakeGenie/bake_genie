            ...
            {orders.length === 0 ? (
              ...
              <div className="divide-y">
                {orders.map((order: any) => {
                  ...
                  // Get customer name - handle both contact object and contact_id cases
                  const customerName = order.contact ? 
                    `${order.contact.firstName || ''} ${order.contact.lastName || ''}`.trim() :
                    'Customer'; // Fallback if contact info is missing
                  
                  // Format the order display to match your reference image
                  ...
                  return (
                    <div 
                      key={order.id}
                      className="p-4 hover:bg-gray-50 cursor-pointer border-l-4 border-transparent hover:border-blue-200"
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className={`w-8 h-8 rounded flex items-center justify-center text-xs font-medium ${
                            isQuote ? 'bg-orange-100 text-orange-600' : 
                          ...
                          <div>
                            ...
                            <div className="text-lg font-medium text-gray-900">
                              {customerName} ({order.eventType})
                            </div>
                            <div className="text-sm text-gray-500">
                              {order.notes || order.items?.[0]?.description || 'Order items'}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="text-right">
                          ...
                          <div className={`inline-block px-2 py-1 rounded text-xs font-medium ${
                            ...
                            order.status === 'Quote' ? 'bg-orange-100 text-orange-800' :
