...
// Direct Order Form with minimal fields directly making API call
const DirectOrderPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit to API (this is known to be working from our tests)
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader title="Direct Order Form" backLink="/orders" backLabel="Orders" />
      
      <div className="p-6">
        <Card>
          <CardHeader>
            <CardTitle>Create New Order (Direct API)</CardTitle>
          </CardHeader>
          <CardContent>
